...
@Composable
fun GeneralTopNewsScreen(navController: NavController,
    ...
    newsViewModel.getTopHeadlines(apiKey,country,"general")
    Box(modifier = Modifier.fillMaxSize()){
        Column (modifier = Modifier
            ...
            Button(onClick = {newsViewModel.getTopHeadlines(apiKey,country,"general")}) {
                Text("Got It")
            }
...
@Composable
fun GeneralNewsCard(label:String?,image:String?,onClick:()->Unit){
