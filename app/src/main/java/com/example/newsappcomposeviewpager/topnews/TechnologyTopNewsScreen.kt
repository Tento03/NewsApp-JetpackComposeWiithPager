...
@Composable
fun TechnologyTopNewsScreen(navController:NavController,
    ...
    newsViewModel.getTopHeadlines(apiKey,country,"technology")
    Box(modifier = Modifier.fillMaxSize()){
        Column (modifier = Modifier.padding(8.dp)
            ...
            Button(onClick = {newsViewModel.getTopHeadlines(apiKey,country,"technology")}) {
                Text("Got It")
            }
...
@Composable
fun TechnologyNewsCard(label:String?,image:String?,onClick:()->Unit){
