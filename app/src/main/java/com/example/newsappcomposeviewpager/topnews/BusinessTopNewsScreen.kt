...
@Composable
fun BusinessTopNewsScreen(navController: NavController,
    ...
    newsViewModel.getTopHeadlines(apiKey,country,"business")
    Box(modifier = Modifier.fillMaxSize()){
        Column (modifier = Modifier
            ...
            Button(onClick = {newsViewModel.getTopHeadlines(apiKey,country,"business")}) {
                Text("Got It")
            }
...
@Composable
fun BusinessNewsCard(label:String?,image:String?,onClick:()->Unit){
