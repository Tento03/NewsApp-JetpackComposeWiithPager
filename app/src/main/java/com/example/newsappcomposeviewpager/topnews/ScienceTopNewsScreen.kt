...
@Composable
fun ScienceTopNewsScreen(navController: NavController,
    ...
    newsViewModel.getTopHeadlines(apiKey,country,"science")
    Box(modifier = Modifier.fillMaxSize()){
        Column (modifier = Modifier.padding(8.dp)
            ...
            Button(onClick = {newsViewModel.getTopHeadlines(apiKey,country,"Science")}) {
                Text("Got It")
            }
...
@Composable
fun ScienceNewsCard(label:String?,image:String?,onClick:()->Unit){
