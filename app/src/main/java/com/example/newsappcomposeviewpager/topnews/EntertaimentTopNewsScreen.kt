...
@Composable
fun EntertaimentTopNewsScreen(navController: NavController,
    ...
    newsViewModel.getTopHeadlines(apiKey,country,"entertaiment")
    Box(modifier = Modifier.fillMaxSize()){
        Column (modifier = Modifier.padding(8.dp)
            ...
            Button(onClick = {newsViewModel.getTopHeadlines(apiKey,country,"entertaiment")}) {
                Text("Got It")
            }
...
@Composable
fun EntertaimentNewsCard(label:String?,image:String?,onClick:()->Unit){
