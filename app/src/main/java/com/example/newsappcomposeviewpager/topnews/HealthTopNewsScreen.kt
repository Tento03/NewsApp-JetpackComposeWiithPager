...
@Composable
fun HealthTopNewsScreen(navController: NavController,
    ...
    newsViewModel.getTopHeadlines(apiKey,country,"health")
...
@Composable
fun HealthNewsCard(label:String?,image:String?,onClick:()->Unit){
